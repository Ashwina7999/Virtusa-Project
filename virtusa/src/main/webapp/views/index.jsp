...
<body>
    ...
    <div class="bgimg w3-animate-opacity"
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <p class="D-M-Y">Saturday, 29 August 2020</p>
          ...
          <p class="temperature"><mark class="temp">24</mark><mark
              ...
              style="margin-left: -13px" src="images/icons/03d.png"></p>

          <h5 class="description" style="color: white;text-align: center;font-weight: bold">scattered clouds</h5>
        ...
        <div class="col-sm-4" style="height: 315px">
          ...
          <p class="wind_degree"><img src="images/icons/wind degree.png" style="background: none;"> <b>Wind Degree</b>
      ...
      <div class="w3-row">
        ...
        <div class="w3-col l3 s6">
          ...
          <div class="w3-container">
            <p><img src="images/icons/latitude.png" style="width: 25px"> <b>Latitude</b><br><mark class="lat">51.51</mark>
            </p>
          </div>
          <br><br>
          <div class="w3-container">
            <p><img src="images/icons/temp min.png" style="width: 25px"><b>Min-Temp</b><br><mark
                class="min_temp">17</mark></p>
          </div>
        </div>
        ...
        <div class="w3-col l3 s6">
          ...
          <div class="w3-container">
            <p><img src="images/icons/01d.png" style="width: 33px"><b>Sun - Rise</b><br><mark
                class="sun_rise">10:24:41</mark></p>
          </div>
          <br><br>
          <div class="w3-container">
        ...
        <div class="w3-col l3 s6">
          <br><br>
          <div class="w3-container">
            <p style="margin-top: 5px;"><img src="images/icons/moon.png" style="width: 20px"> <b>Sun - Set</b><br><mark
                class="sun_set">00:43:20</mark></p>
          </div>
    ...
    <div id="fore_sidebox" class="fore_sidebox">
      ...
      <div class="air_additional" style="color: white;text-align: center;font-family: 'Segoe UI';">
        ...
        <p style="font-family: verdana;color: orange">Note: The Forecating is available only for 16 days from the
          current date</p>
        <br>
          ...
          <div class="card card-1">
            <div class="card-body">
              ...
              <div class="input-group">
                <input class="input--style-1 js-datepicker" id="inpt" name="fname" autocomplete="off" type="text"
                  placeholder="DD/MM/YYE" name="birthday">
    ...
    <div id="id01" class="fore_box">
      ...
      <div class="fore_box-content forebox_animate">
        ...
        <div class="image_container">
          <span onclick="document.getElementById('id01').style.display='none'" class="close_forebox">&times;</span>
          ...
          <div class="fore_additional">
            ...
            <div class="w3-row">
              ...
              <div class="w3-col l3 s6">
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/icon-humidity.png" style="width: 25px"> <b>Humidity</b><br><mark
                      class="fore_humi">72</mark>%</p>
                </div>
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/icon-pressure.png" style="width: 20px"><b>Pressure</b><br><mark
              ...
              <div class="w3-col l3 s6">
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/icon-feels_like.png" style="width: 30px"> <b>Feels Like</b><br><mark
                      class="fore_feels">24</mark>&deg;c</p>
                </div>
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/wind degree.png" style="width: 20px"><b>Wind Degree</b><br><mark
                      class="fore_wind_d">249</mark>&deg;N</p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                ...
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/wind speed.png" style="width: 20px"><b>Wind spd</b><br><mark
                      class="fore_wind_s">7</mark>m/s
                  </p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                ...
                <div class="w3-container">
                  <p style="margin-top: 5px;"><img src="images/icons/visibility.png"
                      style="width: 20px"><b>Visible</b><br><mark class="fore_visi">null</mark></p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                ...
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/temp min.png" style="width: 20px"><b> Min Temp</b><br><mark
                      class="fore_min_t">23</mark>&deg;c</p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                ...
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/uvi.png" style="width: 20px"><b> Uvi</b><br><mark class="fore_uvi">13</mark>
                  </p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                <br><br>
                <div class="w3-container">
                  <p style="margin-top: 5px;"><img src="images/icons/10d.png" style="width: 25px"> <b>Rain</b><br><mark
                      class="fore_rain">1</mark>mm</p>
                </div>

                <br><br>
                <div class="w3-container">
                  <p style="margin-top: 5px;"><img src="images/icons/02d.png" style="width: 23px;"><b> Main</b><br><mark
                      class="fore_main">Clouds</mark></p>
                </div>
              </div>
    ...
    <div id="id02" class="fore_box">
      ...
      <div class="fore_box-content forebox_animate" action="/action_page.php" method="post">
        ...
        <div class="image_container">
          <span onclick="document.getElementById('id02').style.display='none'" class="close_forebox">&times;</span>
          ...
          <div class="fore_additional">
            ...
            <div class="w3-row">
              ...
              <div class="w3-col l3 s6">
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/icon-feels_like.png" style="width: 30px"> <b>precipitation</b><br><mark
                      class="fore_perci">24</mark>&deg;c</p>
                </div>
                <br><br>
                <div class="w3-container">
                  <p><img src="images/icons/wind degree.png" style="width: 20px"><b>Wind Degree</b><br><mark
                      class="fore_wind_d">249</mark></p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                ...
                <div class="w3-container">
                  <p style="margin-top: 5px;"><img src="images/icons/visibility.png"
                      style="width: 20px"><b>Visible</b><br><mark class="fore_visi">21</mark>km</p>
                </div>
              </div>
              ...
              <div class="w3-col l3 s6">
                <br><br>
                <div class="w3-container">
                  <p style="margin-top: 5px;"><img src="images/icons/13d.png" style="width: 25px"> <b>Snow</b><br><mark
                      class="fore_snow">1</mark>mm</p>
                </div>

                <br><br>
                <div class="w3-container">
                  <p style="margin-top: 5px;"><img src="images/icons/02d.png" style="width: 23px;"><b>Moon
  ...
  <div id="mapbox" class="mapbox">
    ...
    <br><br><br><br>
            ...
            <div class="two" style="background-color: white;height: 600px;width: 1600px">
                ...
                <div id="map_large" class="map_large" frameborder="0" allowfullscreen="" aria-hidden="false" tabindex="0" style="height: 100%;width: 100%"></div>
